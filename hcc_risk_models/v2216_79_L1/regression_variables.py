INPUTVARS = ['SEX', 'DOB', 'MCAID', 'NEMCAID', 'OREC']
...
DIAG_CAT = [
    'CANCER','DIABETES','IMMUNE','CHF',   'CARD_RESP_FAIL',
...
# %*interaction variables for Community regressions;
INTERRACC_VARS = [
...
# %*variables for Community regressions ;
COMM_REG = AGESEXV  + ['MCAID_Female_Aged', 'MCAID_Female_Disabled', 'MCAID_Male_Aged', 'MCAID_Male_Disabled'] + INTERRACC_VARS + HCCV22_list79
...
INST_REG = AGESEXV + ['MCAID', 'ORIGDS'] + INTERRACI_VARS + HCCV22_list79
